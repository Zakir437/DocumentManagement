(function () {
    var cabinetId = "", files = [], inputFiles, fileId = 0;
    $(document).ready(function () {
        ...
        $("#divF1List").load('/Document/F1List?q=' + cabinetId);
        $("#divFileList").load('/Document/FileList?cabinetId=' + cabinetId + '&type=1');
    });
   

    $("#divF1List").on('click', '.btnViewDetails', function (e) {
        e.preventDefault();
        var url = $(this).attr("href");
        onAjaxLoad("F1 Details", url);
    });

    $("#divF1List").on('click', '.btnAddFolder', function (e) {
        e.preventDefault();
        var url = $(this).attr("href");
    ...
    $("#btnFileUpload").click(function () {
        if (files.length > 0) {
            ...
            sendData.append("cabinetId", cabinetId);
    ...
    //***********************Edit********************************
    $("#divF1List").on('click', '.btnEditF1', function () {
        var id = $(this).data("id");
        $("#divF1EditWin").empty();
        $("#divF1EditWin").kendoWindow({
            actions: ["Close"],
            draggable: false,
            modal: true,
            visible: false,
        ...
        var f1EditWin = $("#divF1EditWin").data("kendoWindow");
        f1EditWin.refresh('/Document/F1Edit?id=' + id);
