(function () {
    var f1Id = "", files = [], inputFiles, fileId = 0;
    $(document).ready(function () {
        ...
        $("#divF2List").load('/Document/F2List?q=' + f1Id);

        $("#divFileList").load('/Document/FileList?f1Id=' + f1Id + '&type=2');
    });

    $("#divF2List").on('click', '.btnViewDetails', function (e) {
        e.preventDefault();
    ...
    //***********************Edit********************************
    $("#divF2List").on('click', '.btnEditF2', function () {
        var id = $(this).data("id");
        $("#divF2EditWin").empty();
        $("#divF2EditWin").kendoWindow({
            actions: ["Close"],
            draggable: false,
            modal: true,
            visible: false,
        ...
        var f2EditWin = $("#divF2EditWin").data("kendoWindow");
        f2EditWin.refresh('/Document/F2Edit?id=' + id);
